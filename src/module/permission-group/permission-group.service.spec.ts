...
describe('PermissionGroupService', () => {
  ...
  describe('Create', () => {
    ...
    it('should create a permission group', async () => {
      const result = await permissionGroupService.create(
  ...
  describe('List', () => {
    ...
    it('should list all permission groups by a user type id', async () => {
      const result = await permissionGroupService.list(queryPermissionGroupDto);

      expect(result).toStrictEqual(listPermissionGroupResponse);
    });

    it('shoudl list all permission groups', async () => {
      const result = await permissionGroupService.list({});
  ...
  describe('Delete', () => {
    ...
    it('should delete a permission group by id', async () => {
      const result = await permissionGroupService.delete(permissionGroupId);
